...
public class MyBookingAdapter extends RecyclerView.Adapter<MyBookingAdapter.BookingViewHolder> {
    ...
    public BookingViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_my_bookings, parent, false);
    ...
    public void addBookingDataList(List<MyBookingResponse.MyBookingData> myBookingDataList){
